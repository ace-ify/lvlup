...
load_dotenv(dotenv_path="c:/ace/lvlup/.env", override=True)
...
def create_kb():
    ...
    doc=Document(page_content=KNOWLEDGE_BASE,metadata={"source":"kuchbhilikhunga.md"})
...
def demo_basic_rag():
    ...
    prompt=ChatPromptTemplate.from_template(
        ...
        Make sure to answer in caveman manner and in simple and easy language.
        and if u dont know the answer simply say "mujhe nahi pata mai ganvaar hu"
        """
    )
